...
if (dsn) {
  Sentry.init({
    ...
    environment:
      optionalValue(process.env.NEXT_PUBLIC_SENTRY_ENV) ??
      process.env.NODE_ENV ??
      "development",
    release:
      optionalValue(process.env.NEXT_PUBLIC_SENTRY_RELEASE) ??
      optionalValue(process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA),
